# Generated by Powerlevel10k configuration wizard on 2021-09-30 at 19:28 EEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${bluee}${git_skobka_lev}${redd}${branch//\%/%%}${bluee}${git_skobka_prav}"
    fi
