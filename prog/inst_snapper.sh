...
sudo sed -i 's/^TIMELINE_LIMIT_DAILY=.*/HTIMELINE_LIMIT_DAILY="3"/g' /etc/snapper/configs/root
sudo sed -i 's/^TIMELINE_LIMIT_WEEKLY=.*/HTIMELINE_LIMIT_WEEKLY="7"/g' /etc/snapper/configs/root
